 ...
 */
final class Version20230312182354 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE item_server (id INT AUTO_INCREMENT NOT NULL, item_id INT NOT NULL, server_id INT NOT NULL, percentage INT NOT NULL, INDEX IDX_DC94A039126F525E (item_id), INDEX IDX_DC94A0391844E6B7 (server_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE item_server ADD CONSTRAINT FK_DC94A039126F525E FOREIGN KEY (item_id) REFERENCES item (id)');
        $this->addSql('ALTER TABLE item_server ADD CONSTRAINT FK_DC94A0391844E6B7 FOREIGN KEY (server_id) REFERENCES server (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item_server DROP FOREIGN KEY FK_DC94A039126F525E');
        $this->addSql('ALTER TABLE item_server DROP FOREIGN KEY FK_DC94A0391844E6B7');
        ...
        $this->addSql('DROP TABLE item_server');
